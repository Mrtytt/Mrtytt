...
<table>
  <tr>
    ...
    <td>Modular Monolith, Multi-Tenant Systems, Metadata-Driven Architecture, CQRS, Controlled Runtime Operations</td>
  </tr>
  <tr>
    <td><strong>Backend</strong></td>
    <td>.NET 8, ASP.NET Core, C#, Dapper, Python, FastAPI, REST APIs</td>
  </tr>
  <tr>
...
> Business rules belong in trusted backend services.  
> Metadata should remain a consistent source of truth.  
> AI should assist and plan; deterministic systems should execute.  
> Automation must be controlled, observable, and auditable.  
> Production reliability matters more than demo shortcuts.
...
<p align="center">
  ...
  <sub>Founder &amp; CTO at Cody &middot; Enterprise Platforms &middot; AI-Assisted Product Engineering</sub>
</p>
